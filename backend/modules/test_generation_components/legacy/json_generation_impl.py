...
_PARTS = (
    'json_generation_impl_parts/json_generation_impl_part1.py.part',
    'json_generation_impl_parts/json_generation_impl_part2.py.part',
    'json_generation_impl_parts/json_generation_impl_part3.py.part'
)
