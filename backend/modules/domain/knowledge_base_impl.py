...
_PARTS = (
    'knowledge_base_impl_parts/knowledge_base_impl_part1.py.part',
    'knowledge_base_impl_parts/knowledge_base_impl_part2.py.part',
    'knowledge_base_impl_parts/knowledge_base_impl_part3.py.part'
)
