...
调用关系：
- 依赖 `core.authn.auth` 提供的密码哈希和 Token 生成工具。
- 调用 `core.settings.config_manager` 在注册时初始化用户配置。
"""
...
from core.authn.auth import verify_password, get_password_hash, create_access_token, get_current_user
